    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task1()
        {
            ...
            var resLinq = Emps.Where(e => e.Job == "Backend programmer");
        ...
        public void Task2()
        {
            var res = Emps.Where(e => e.Job == "Backend programmer" && e.Salary > 1000)
        ...
        public void Task3()
        {
            ...
            var res2 = (from e in Emps
                       select  e.Salary).Max();
            Console.WriteLine("Max Salary:" + res2);
        }
        ...
        public void Task10()
        {
           var res = Emps.Select(e => new { e.Ename, e.Job, e.HireDate })
              .Union(Emps.Select(y=>new { Ename = "No value",Job=string.Empty,HireDate=(DateTime?)null}));

            var res2 = (from e in Emps
                       select new { e.Ename, e.Job, e.HireDate })
                       .Union(from e in Emps
                              select new { Ename = "No value", Job = string.Empty, HireDate = (DateTime?)null });
        ...
        public void Task11()
        {
            var emp = Emps.Aggregate((e1, e2) => e1.Salary > e2.Salary ? e1 : e2);
        }
